...
import type { BaseResponse_HashMap_string_HashMap_string_string_ } from '../models/BaseResponse_HashMap_string_HashMap_string_string_';
...
export class QuestionControllerService {
    ...
    /**
     * GitConfig
     * @returns BaseResponse_HashMap_string_HashMap_string_string_ OK
     * @throws ApiError
     */
    public static gitConfigUsingGet(): CancelablePromise<BaseResponse_HashMap_string_HashMap_string_string_> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    /**
     * getQuestionSumbitVOById
     * @param id id
     * @returns BaseResponse_QuestionSubmit_ OK
     * @throws ApiError
     */
    public static getQuestionSumbitVoByIdUsingGet(
        id?: number,
    ): CancelablePromise<BaseResponse_QuestionSubmit_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/question/get/quesiton_sumbit',
            query: {
                'id': id,
            },
            errors: {
    ...
    /**
     * listQuestionSubmitUserByPage
     * @param questionSubmitQueryRequest questionSubmitQueryRequest
     * @returns BaseResponse_Page_QuestionSubmitVO_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static listQuestionSubmitUserByPageUsingPost(
        questionSubmitQueryRequest: QuestionSubmitQueryRequest,
    ): CancelablePromise<BaseResponse_Page_QuestionSubmitVO_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/question_submit/list/page/usermessge',
            body: questionSubmitQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
